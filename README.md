...
4. If there are electrical components these can be modeled using the _extradynamics_ function (see the magnetic levitation example and the associated [description file](examples/magnetic_levitation/maglev_description.pdf) ).
